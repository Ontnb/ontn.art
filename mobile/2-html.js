...
const photoDir = path.join(__dirname, '../23');
// Путь к выходному HTML-файлу
const outputFile = path.join(__dirname, '23.html');
    ...
    imageFiles.forEach((file, index) => {
        htmlContent += `
            <div class="portfolio-item">
                <img src="../23/${file}" alt="Photo ${index + 1}" data-index="${index}">

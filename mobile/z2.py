    ...
    return f"""
            <div class="portfolio-item">
                <div class="video-container">
                    <video class="portfolio-video" preload="metadata" data-src="../{media_folder_name}/{video_filename}" poster="../{media_folder_name}/{poster_filename}" playsinline webkit-playsinline>

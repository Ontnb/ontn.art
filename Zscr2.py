...
photo_dir = os.path.join(os.getcwd(), '18')
# Путь к выходному HTML-файлу
output_file = os.path.join(os.getcwd(), '18.html')
    ...
    if file_extension in ['.webp', '.jpg']:
        html_content += f'''
            <div class="portfolio-item">
                <img src="18/{file}" alt="Photo {index + 1}">
        ...
        html_content += f'''
            <div class="portfolio-item">
                <video controls>
                    <source src="18/{file}" type="video/webm">
        ...
        html_content += f'''
            <div class="portfolio-item">
                <video controls>
                    <source src="18/{file}" type="video/mp4">
                    Ваш браузер не поддерживает видео.
                </video>
                <p class="photo-caption"><!-- Подпись --></p>
            </div>
